...
class PilotList(gui_dialogmodel.DialogModel):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.list_ctrl.InsertColumn(
            0, _("Degree"), 'degree', proportion=2)
        self.list_ctrl.InsertColumn(
            1, _("Name"), 'firstname', proportion=3)
        self.list_ctrl.InsertColumn(
            2, _("Surname"), 'surname', proportion=4)
        self.list_ctrl.InsertColumn(
            3, _("Year of birth"), 'year_of_birth',
            format=wx.LIST_FORMAT_RIGHT, proportion=1.5)
        self.list_ctrl.InsertColumn(
            4, _("Sex"), 'sex', proportion=1)
...
class PilotForm(wx.Dialog):
    ...
    def __do_layout(self):
        ...
        grid_sizer.Add(
            self.label_degree, (0, 0), (1, 2), wx.RIGHT | wx.EXPAND, 2)
        grid_sizer.Add(
            self.label_firstname, (0, 2), (1, 3),
            wx.LEFT | wx.RIGHT | wx.EXPAND, 2)
        grid_sizer.Add(
            self.label_surname, (0, 5), (1, 3), wx.LEFT | wx.EXPAND, 2)
        grid_sizer.Add(
            self.text_degree, (1, 0), (1, 2),
            wx.RIGHT | wx.BOTTOM | wx.EXPAND, 2)
        grid_sizer.Add(
            self.text_name, (1, 2), (1, 3),
            wx.LEFT | wx.RIGHT | wx.BOTTOM | wx.EXPAND, 2)
        grid_sizer.Add(
            self.text_surname, (1, 5), (1, 3),
            wx.LEFT | wx.BOTTOM | wx.EXPAND, 2)
        grid_sizer.Add(
            self.label_year_of_birth, (2, 0), (1, 2),
            wx.RIGHT | wx.EXPAND, 2)
        grid_sizer.Add(
            self.label_sex, (2, 2), (1, 1),
            wx.LEFT | wx.RIGHT | wx.EXPAND, 2)
        grid_sizer.Add(
            self.text_year_of_birth, (3, 0), (1, 2),
            wx.RIGHT | wx.BOTTOM | wx.EXPAND, 2)
        grid_sizer.Add(
            self.text_sex, (3, 2), (1, 1),
            wx.LEFT | wx.RIGHT | wx.BOTTOM | wx.EXPAND, 2)
        grid_sizer.Add(
            self.label_description, (4, 0), (1, 8),
            wx.RIGHT | wx.EXPAND, 2)
        grid_sizer.Add(
            self.text_description, (5, 0), (1, 8),
