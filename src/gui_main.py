...
class Main(wx.Frame):
    ...
    def __init__(self, *args, **kwds):
        ...
        self.label_glider_class = wx.StaticText(self.panel_card, -1, _("Glider class"))
    ...
    def __set_properties(self):
        ...
        self.text_glider_class.SetFont(wx.Font(15, wx.DEFAULT, wx.NORMAL, wx.NORMAL, 0, ""))
    ...
    def __do_layout(self):
        ...
        sizer_card_base.Add(self.label_glider_type, (2, 0), (1, 1), wx.BOTTOM|wx.EXPAND, 2)
        sizer_card_base.Add(self.label_glider_class, (2, 1), (1, 1), wx.BOTTOM|wx.EXPAND, 2)
        sizer_card_base.Add(self.text_glider_type, (3, 0), (1, 1), wx.BOTTOM|wx.EXPAND, 2)
        sizer_card_base.Add(self.text_glider_class, (3, 1), (1, 1), wx.BOTTOM|wx.EXPAND, 2)
