...
class DialogModel(gui_forms.DialogModel):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.menu_new = wx.MenuItem(
            self.menu_popup, wx.NewId(), _("&New...\tInsert"))
        self.menu_popup.AppendItem(self.menu_new)
        self.menu_properties = wx.MenuItem(
            self.menu_popup, wx.NewId(), _("&Edit...\tEnter"))
        self.menu_popup.AppendItem(self.menu_properties)
        self.menu_delete = wx.MenuItem(
            self.menu_popup, wx.NewId(), _("&Delete\tCtrl+Delete"))
        ...
        self.Bind(wx.EVT_LIST_COL_CLICK, self.__sort_datasource,
                  self.list_ctrl)
    ...
    def set_datasource(self, value):
        """
        datasource(self, list value) - set datasource, value is a
        SQLAlchemy query
        """
    ...
    def __sort_datasource(self, evt):
        """
        __sort_datasource(self, evt) - sort datasource, left-click column
        tile event handler
        """
        self.Sort(evt.m_col)
