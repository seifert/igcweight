...
class OrganizationForm(wx.Dialog):
    ...
    def __do_layout(self):
        ...
        grid_sizer.Add(
            self.label_name, (0, 0), (1, 1), wx.RIGHT | wx.EXPAND, 2)
        grid_sizer.Add(
            self.label_code, (0, 1), (1, 1), wx.LEFT | wx.RIGHT | wx.EXPAND, 2)
        grid_sizer.Add(
            self.text_name, (1, 0), (1, 1),
            wx.RIGHT | wx.BOTTOM | wx.EXPAND, 2)
        grid_sizer.Add(
            self.text_code, (1, 1), (1, 1),
            wx.LEFT | wx.RIGHT | wx.BOTTOM | wx.EXPAND, 2)
        grid_sizer.Add(
            self.label_description, (2, 0), (1, 2), wx.RIGHT | wx.EXPAND, 2)
        grid_sizer.Add(
            self.text_description, (3, 0), (1, 2), wx.BOTTOM | wx.EXPAND, 2)
